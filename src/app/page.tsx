        ...
        <div className="intro-grid">
          ...
          <div className="intro-body">
            <TextReveal
              ...
              text="I work in the gap between a clean equation and a part that has to survive the bench."
            />
      ...
      <section className="section shell" id="work">
        <div className="section-head">
          <div className="section-head-lead">
            <span className="readout">Fig. 02 · seven specimens · live</span>

...
export const keebNotes = [
  { k: "Ergonomics", v: "65% so the mouse sits closer — less shoulder reach, more desk for the notebook." },
  { k: "Tuning", v: "Switches lubed, stabs band-aid-modded. The boring 20 minutes that fix 80% of the sound." },
  { k: "Hot take", v: "Tactiles are for typing, linears are for thinking. I do most of my CAD on linears." },
];

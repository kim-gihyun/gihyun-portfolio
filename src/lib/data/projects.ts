...
export const projects: Project[] = [
  {
    id: "teng-gyroid",
    num: "P-00",
    title: "Gyroid TENG Fabric",
    tag: "Shin Group · HKU Research",
    year: "2026",
    role: "Materials & fabrication research",
    status: "Active research",
    categories: ["research", "materials"],
    model: "__gyroid__", // rendered live in WebGL, no glb
    poster: "/assets/blog/ra2-p2-02.png",
    featured: true,
    blurb:
      "A triply-periodic minimal surface, generated in MATLAB and 3D-printed in TPU, engineered as the substrate for a self-powered triboelectric input device.",
    body: [
      "The substrate is a gyroid — sin(x)cos(y) + sin(y)cos(z) + sin(z)cos(x) = c — printed 400–600 µm thick with a dense 50×50 mm core for the electrode bed and a softer outer ring that conforms to the body.",
      "The idea: a watch-like structure from a single material and pattern, where density alone tunes stiffness. Electrodes sit stress-free for clean signals while only the outer region flexes under load.",
      "Conductive TPU (C-TPU) electrodes are printed onto the core. The surface you can orbit here is the real implicit gyroid, ray-marched in your browser from the same equation that drives the MATLAB export.",
    ],
    specs: [
      { k: "Surface", v: "Gyroid (TPMS)" },
      { k: "Thickness", v: "400–600 µm" },
      { k: "Substrate", v: "TPU" },
      { k: "Electrode", v: "C-TPU" },
      { k: "Toolchain", v: "MATLAB → STL → Prusa" },
    ],
    context: [
      {
        title: "Anisotropy by geometry",
        text: "The gyroid resists tensile stress yet bends easily to conform — anisotropic behaviour designed into the lattice, not the chemistry.",
      },
      {
        title: "One material, two jobs",
        text: "A ~55% denser core carries the electrodes stress-free; the looser outer region does the flexing. Same filament, tuned by density.",
      },
    ],
    revs: [
      { rev: "A", note: "Implicit gyroid generated in MATLAB; isosurface exported to STL.", year: "2026" },
      { rev: "B", note: "Variable-density core/outer transition mapped for electrode bed.", year: "2026" },
      { rev: "C", note: "C-TPU electrode grid validated — 4 contact points, minimal crosstalk.", year: "2026" },
    ],
    gallery: [
      { src: "/assets/blog/ra2-p2-02.png", alt: "Gyroid structure generated in MATLAB" },
      { src: "/assets/blog/ra2-p2-03.png", alt: "Gyroid imported into SolidWorks — isometric and top views" },
      { src: "/assets/blog/ra2-p6-10.png", alt: "Fabricated electrode grid" },
    ],
  },
  {
    id: "robocon-robot",
